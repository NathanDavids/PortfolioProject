  ...
  return (
    ...
    <div id='blogContainer' className='flex flex-col h-full w-full'>
        ...
        <div className="blogPostContainer grid ml-20 md:ml-0 lg:ml-0 md:flex md:flex-wrap justify-center items-center h-full w-full overflow-hidden gap-4 md:gap-8">
          <div className="postOne items-center w-[70%] h-[68%] md:w-1/1 md:h-[26%] lg:w-1/4 lg:h-[75%] xl:w-1/4  flex flex-col space-y-7">
          ...
          <div className="postTwo w-[70%] h-[68%] md:w-1/1 md:h-[26%] lg:w-1/4 lg:h-[75%] xl:w-1/4  flex flex-col space-y-7">
                  ...
                  <div className="postThree w-[70%] h-[68%] md:w-1/1 md:h-[26%] lg:w-1/4 lg:h-[75%] xl:w-1/4 flex flex-col space-y-7">
